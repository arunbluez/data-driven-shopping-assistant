...
export default function Stepper({ steps, currentStepNumber }: Props) {
  const [stepperSteps, setStep] = useState<stepObject[]>([])
  const stepsStateRef = useRef<any>()

  useEffect(() => {
    const stepsState = steps.map((step, index) => {
      const stepObj: stepObject = {}
  ...
  function updateStep(stepNumber: number, steps: stepObject[]) {
